...
// 以下、JRA-VAN Data Lab. SDK Ver4.9.0.2 付属の JV-Data構造体(C#版) JVData_Struct.cs を
// そのまま配置したもの（バイトオフセット等のロジックは無編集）。
// プロジェクトの名前空間規約に合わせるため namespace 宣言のみ追加している。
namespace KeibaDataCollector.Interop.JvDataSdk
{
