...
| `KeibaDataCollector-Predict` | 毎日 09:00 から30分ごと×6時間 | 朝一オッズの人気順から予想印を生成・反映 |
...
**地方競馬のオッズは朝のうちに順次配信されます。** 9時に1回動かすだけでは全レースを賄えません。
...
09:31に取得できたのは盛岡10Rと浦和11Rのみで、いずれも前日発売が行われる主要レースでした。

そのため予想生成は09:00から**30分ごとに6時間**繰り返し、オッズが出たレースから順に埋めます。
